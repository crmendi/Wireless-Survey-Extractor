...
-   **Seleccionar Archivos ESX... (Ctrl+O):** Ve a `Archivo > Seleccionar Archivos ESX...` para abrir uno o varios archivos de proyecto de Extractor (`.esx`). Los datos de los puntos de acceso (APs) se cargarán y mostrarán en la tabla principal.
